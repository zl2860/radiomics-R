...
logistic.fit = glm(PCR ~ radscore, data = radscore_df, family = binomial(link = "logit"))
logistic.fit_norad = glm(PCR ~ . -name - radscore, data = outcome_df_2020, family = binomial(link = "logit"))
